...
public class KafkaConfig {
	...
	// Handles only kafka transactions
	@Bean(name = "kafkaTransactionManager")
	KafkaTransactionManager<String, Object> kafkaTransactionManager(ProducerFactory<String, Object> producerFactory) {
		return new KafkaTransactionManager<>(producerFactory);
	}

	// When neither kafka or jpa transactionManger is create spring creates a default 'transactionManger'
	// In this case we are creating both, spring is expecting a 'transactionManager' bean,
	// We need to name the bean as 'transactionManager' as expected by Spring
	// It will handle kafka and jpa transactions
